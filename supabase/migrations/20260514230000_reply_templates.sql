-- Source: apps/spectrum-crm/supabase-migration-reply-templates.sql (source PR #16, commit b6323aa)
-- Mirrored into the live repo's timestamp-prefixed supabase/migrations/ convention.

-- ============================================================
-- Spectrum CRM — Reply Templates Table
--
